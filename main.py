...
from utils import describeDataset, loadImageData, split_data, plot_histogram, normalisation, \
    convertPixelsMatrixIntoGrayScaleArray, training, classification, evalMultiClass, createModel
...
if __name__ == "__main__":
    ...
    accuracy, precision, recall, cm = evalMultiClass(np.array(test_outputs), computed_test_outputs,
                                                     ['FreshApple', 'FreshBanana', 'FreshGrape', 'FreshGuava', 'FreshJujube', 'FreshOrange',
                                                      'FreshPomegranate', 'FreshStrawberry', 'RottenApple', 'RottenBanana', 'RottenGrape', 'RottenGuava',
